<template>
  <div class="container w-3/4 lg:w-3/4 sm:w-4/4">
    <h1 class="title sm:mt-10">Returns</h1>
    <div
      v-for="(item,key) in 7 "
      :key="key"
